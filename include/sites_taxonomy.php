...
if(isset($_POST['st_addtag_action']) && $_POST['st_addtag_action'] == 'Y' && isset($_POST['_wpnonce']) && wp_verify_nonce($_POST['_wpnonce'], 'add-t4ns-new')) {
    ...
    /*error_log("New row added: ".$newTerm);
    error_log("values sent: ");
    error_log(print_r($values, true));
    error_log("Format sent: ");
    error_log(print_r($format, true));*/
    // if($newTerm) $successful=true;
                ...
                <div class="tablenav top">
                    ...
                    <div class="tablenav-pages one-page">
                        ...
                        <span class="pagination-links">
                            <a class="first-page disabled" title="<?php echo __('Go to the first page', 'sitesTax_syllogic_in');?>" href="./sites_taxonomy.php?taxonomy=category">«</a>
                            <a class="prev-page disabled" title="<?php echo __('Go to the previous page', 'sitesTax_syllogic_in');?>" href="./sites_taxonomy.php?taxonomy=category&amp;paged=1">‹</a>
                            ...
                            <a class="next-page disabled" title="<?php echo __('Go to the next page', 'sitesTax_syllogic_in');?>" href="./sites_taxonomy.php?taxonomy=sites_category&amp;paged=1">›</a>
                            <a class="last-page disabled" title="<?php echo __('Go to the last page', 'sitesTax_syllogic_in');?>" href="./sites_taxonomy.php?taxonomy=sites_category&amp;paged=1">»</a></span>
                    </div>
                    <br class="clear">
                </div>
