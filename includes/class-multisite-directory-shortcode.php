...
<?php
    ...
    public static function register () {
         ...
         * Shortcake (Shortcode UI) is a feature plugin that may soon be added to core. It is much easier than adding quicktags and more intuitive for users.
         *
         * @link https://github.com/wp-shortcake/shortcake
         */
